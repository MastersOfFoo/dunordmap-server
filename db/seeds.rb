...
# Bloque C
#_________________________________________________________________________________________________
Building.where(longitude: -74.85126225180640, latitude: 11.019033813694275, name: 'Bloque C', history: 'En el período del rector Boris Rosanía Salive quien inicia la construcción de este edificio la cual fue finalizada en el año 1976').first_or_create do |building|
...
# Bloque D
#_________________________________________________________________________________________________
Building.where(longitude: -74.85045490680214, latitude: 11.018265366064451, name: 'Bloque D', history: 'En diciembre de 1973 se posesionó como rector el ingeniero Boris Rosanía Salive quien inicia la construcción de este edificio la cual fue finalizada en el año 1974').first_or_create do |building|
...
# Bloque E
#_________________________________________________________________________________________________
Building.where(longitude: -74.85034889180159, latitude: 11.018521515497374, name: 'Bloque E', history: 'En el período del rector Boris Rosanía Salive quien inicia la construcción de este edificio la cual fue finalizada en el año 1977').first_or_create do |building|
...
# Bloque F
#_________________________________________________________________________________________________
Building.where(longitude: -74.85031627180142, latitude: 11.018769660047887, name: 'Bloque F', history: 'En el período del rector Boris Rosanía Salive quien inicia la construcción de este edificio la cual fue finalizada en el año 1979').first_or_create do |building|
...
elementos concernientes a un edificio inteligente.').first_or_create do |building|
